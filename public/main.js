            ...
            for (i = 0; i < textedJson.items.length; i++) {
                ...
                <div class="col-4">
                        <div class="card">
                            ...
                            <img class="card-img-top" src="https://auction-deno-api.herokuapp.com/uploads/${textedJson.items[i].img_src}" alt="Card image cap" style="object-fit: contain; width: 100%; height: 200px;">
                            <div class="card-body">
                                <h5 class="card-title">
        ...
        .then(data => {
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <img class="card-img-top" src="https://auction-deno-api.herokuapp.com/uploads/${data.items.itemdetails[0].item_name}" alt="Card image cap" style="object-fit: contain; width: 100%; height: 350px;">
                    <div class="card-body">
                        <h5 class="card-title">
